...
class SubscriptionOptionCard extends StatelessWidget {
  ...
  String get _title {
    if (isQuarterly) return 'Three months access';
    if (isWeekly) return 'One week access';
    return 'One month access';
  }
  ...
  String get _subtitle {
    ...
    if (isQuarterly) {
      ...
      return 'For serious betters';
    } else if (isWeekly) {
      return 'Try it out'; // No subtitle for weekly plans
    } else {
      return 'Best offer';
    }
  }
  ...
  double _getSavings() {
    ...
    if (!isWeekly && !isQuarterly && weeklyPackage != null) {
      ...
      return weeklyMonthlyEquivalent -
          monthlyPrice; // Return dollar amount saved
    }
    return 0.0;
  }
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      isQuarterly
                          ? '\$${offeringPackage.storeProduct.price.toStringAsFixed(2)}'
                          : isWeekly
                              ? '\$${offeringPackage.storeProduct.price.toStringAsFixed(2)}'
                              : '\$${_getMonthlyPrice().toStringAsFixed(2)}',
                      style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
